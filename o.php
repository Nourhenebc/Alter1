      ...
      <div class="card">
        ...
        <div >
          ...
          <form  action="ajout.php" method="POST" action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-15 u-form-vertical u-inner-form" source="email" name="form" style="padding: 23px; margin-bottom: 222;">
            ...
            <div class="u-form-group u-form-name">
              <label for="name-4c18" class="u-label">Id</label> 
              <input type="text"  name="nom" placeholder="Id" id="name-4c18"  class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10" required="">
            </div>
            <div class="u-form-email u-form-group">
              <label for="email-4c18" class="u-label">Type</label>
              <input type="email" name="prenom" placeholder="Type" id="email-4c18"  class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10" required="">
            </div>
            <div class="u-form-group u-form-group-4">
              <label for="text-8936" class="u-label">File </label>
              <input type="text" placeholder="File" id="text-8936"  class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10">
            </div>
            <div class="u-form-group u-form-group-4">
              <label for="text-8936" class="u-label">File </label>
              <input type="text" placeholder="File" id="text-8936" class="u-border-2 u-border-grey-10 u-grey-10 u-input u-input-rectangle u-radius-10">
            ...
            <input type="hidden" name="formServices" value="57459020276606cba80a50d458da67d7">             </div>
                ...
                <table class="u-table-entity u-table-entity-1">
                  ...
                  <thead class="u-align-center u-grey-10 u-table-header u-table-header-1">
                    <tr style="height: 86px;">
                      ...
                      <th class="u-border-2 u-border-palette-1-light-1 u-palette-1-base u-table-cell u-table-cell-5">Remove</th>
                    </tr>
                  </thead>
                  <tbody class="u-align-center u-grey-90 u-table-alt-grey-80 u-table-body u-table-body-1">
                    <tr style="height: 77px;">
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-6">10 Gb</td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-7"> </td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-8">15 Gb</td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-9">  <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-palette-2-base u-radius-20 u-btn-1">Update</a></td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-10"> <a href="#" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-palette-2-base u-radius-20 u-btn-1">delete</a></td>
                    </tr>
                    <tr style="height: 67px;">
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-11">2</td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-12"></td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-13">5</td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-14"></td>
                      <td class="u-border-2 u-border-grey-75 u-table-cell u-table-cell-15"></td>
                    </tr>
                  </tbody>
                </table>
              </div>

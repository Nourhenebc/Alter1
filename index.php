...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
					    ...
					    <div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">Avicenne@esprit.tn</span>
					    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Avicenne</a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
			  ...
			  <li class="nav-item"><a href="#feedback-section" class="nav-link"><span>Feedbacks</span></a></li>
	  ...
	  <section class="hero-wrap js-fullheight" style="background-image: url('images/t.gif');" data-section="home" data-stellar-background-ratio="0.5">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 pt-5 ftco-animate">
          	<div class="mt-5">
	            ...
	            <p class="mb-4">Your mental health is a priority. Your happiness is an essential. Your self-care is a necessity. </p>
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(images/2.gif);">
    				</div>
    			</div>
    			<div class="col-md-6 col-lg-7 pl-lg-5 py-md-5">
    				<div class="py-md-5">
			          ...
			          <div class="col-md-12 heading-section ftco-animate p-4 p-lg-5">
			            <h2 class="mb-4">We Are <span>Avicenne</span> A Mental Health Hospital</h2>
			            <p>Avicenne was established in 2008 to provide compassionate care for those struggling with mental health issues. We noticed a lack of understanding and mistreatment surrounding mental health, which can have severe consequences like the risk of suicide. Therefore, we incorporate meditation and art therapy into our treatment plans, believing that holistic approaches promote long-term healing and wellness. Our team of compassionate professionals collaboratively develops personalized treatment plans in a safe and nurturing environment. Explore our website to learn more about our services, and know that you are not alone on your journey to healing and wellness.</p>
			            <p><a href="#feedback-section" class="btn btn-primary py-3 px-4"> Your Feedbacks</a> <a  href="#contact-section" class="btn btn-secondary py-3 px-4">Contact us</a></p>
			          </div>
			        </div>
		        </div>
	        </div>
    ...
    <section class="ftco-intro img" style="background-image: url(images/p.gif);">
			<div class="overlay"></div>
			<div class="container">
    	...
    	<div class="container-fluid px-0">
    		<div class="row no-gutters">
    			<div class="col-md-4 d-flex">
    				<div class="img img-dept align-self-stretch"  style="background-image: url(images/200w.gif);"></div>
    			</div>
    					...
    					<div class="col-md-4">
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a  href="#" style="background-image: url(images/event.gif);">Mental health </a></h3>
    						...
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="#">Nutrition Advices </a></h3>
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
    					...
    					<div class="col-md-4">
    						...
    						<div class="department-wrap p-4 ftco-animate">
    							<div class="text p-2 text-center">
    								...
    								<h3><a href="#">Calories Tracking </a></h3>
    								<p>Far far away, behind the word mountains</p>
    							</div>
    						</div>
    						<div class="department-wrap p-4 ftco-animate">
		...
		<section class="ftco-facts img ftco-counter" style="background-image: url(images/l.gif);">
			<div class="overlay"></div>
			<div class="container">
    ...
    <section class="ftco-section testimony-section img" style="background-image: url(images/v.gif);">
    	<div class="overlay"></div>
      <div class="container">
	...
	<div class="container mt-5">
        ...
        <div class="row no-gutters block-9"id="feedback-section">
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Mental Health</a></li>
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Music Playlist</a></li>
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Nutrition advices</a></li>
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Calories Tracking</a></li>
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Teletherapy</a></li>
                <li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Schedule</a></li>
				<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>events</a></li>
				<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Sponsors</a></li>
				<li><a href="#"><span class="icon-long-arrow-right mr-2"></span>Old events </a></li>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4 ml-md-4">
              ...
              <ul class="list-unstyled">
				...
				<li><a href="#feedback-section"><span class="icon-long-arrow-right mr-2"></span>Feedbacks</a></li>
